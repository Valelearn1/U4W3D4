...
import valentinaferro.u4w3d4.payloads.ErrorResponse;
import valentinaferro.u4w3d4.payloads.ErrorsWithListDTO;
...
public class GlobalExceptionHandler {
	...
	// 403: l'utente è autenticato ma NON ha i permessi per questa operazione.
	// Copre sia i controlli programmatici (es. BlogPostService quando non sei l'autore)
	// sia i fallimenti di @PreAuthorize (AuthorizationDeniedException estende AccessDeniedException).
